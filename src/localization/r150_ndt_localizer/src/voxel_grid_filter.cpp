...
#include <r150_ndt_localizer/PointsDownsamplerInfo.h>
...
static r150_ndt_localizer::PointsDownsamplerInfo points_downsampler_info_msg;
...
int main(int argc, char** argv)
{
  ...
  points_downsampler_info_pub = nh.advertise<r150_ndt_localizer::PointsDownsamplerInfo>("/points_downsampler_info", 1000);
